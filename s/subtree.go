...
func (spec SupervisorSpec) run(
	...
	supChildrenSpecs, rscCleanup := spec.buildChildrenSpecs()

	// We make sure that once the wait call finishes, we cleanup all the resources
	// generated by the children construction function.
	//
	// TODO: Add timeout to rscCleanup call
	defer rscCleanup()
